...
API_KEY = "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"    # 可同时填写多个API-KEY，用英文逗号分割，例如API_KEY = "sk-openaikey1,sk-openaikey2,fkxxxx-api2dkey3,azure-apikey4"
...
if USE_PROXY:
    ...
    proxies = {
        #          [协议]://  [地址]  :[端口]
        "http":  "127.0.0.1:8890",  # 再例如  "http":  "http://127.0.0.1:7890",
        "https": "127.0.0.1:8890",  # 再例如  "https": "http://127.0.0.1:7890",
    }
else:
    proxies = None
